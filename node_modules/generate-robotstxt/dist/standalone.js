...
exports.default = function () {
  ...
  return Promise.resolve().then(function () {
    return buildConfig(configFile).then(function (result) {
...
function buildConfig() {
  var configFile = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  if (configFile) {
    searchPath = null;
    configPath = _path2.default.resolve(process.cwd(), configFile);
  }

  var configExplorer = (0, _cosmiconfig2.default)("robots-txt");
  var searchForConfig = configPath ? configExplorer.load(configPath) : configExplorer.search(searchPath);

  return searchForConfig.then(function (result) {
    if (!result) {
      return {};
    }
